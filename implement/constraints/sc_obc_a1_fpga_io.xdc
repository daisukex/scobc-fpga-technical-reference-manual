...
set_property [get_ports {SRAM1_IO[0]}]        -dict { PACKAGE_PIN H19  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[1]}]        -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[2]}]        -dict { PACKAGE_PIN J19  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[3]}]        -dict { PACKAGE_PIN J18  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[4]}]        -dict { PACKAGE_PIN K17  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[5]}]        -dict { PACKAGE_PIN L17  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[6]}]        -dict { PACKAGE_PIN K15  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[7]}]        -dict { PACKAGE_PIN L14  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[8]}]        -dict { PACKAGE_PIN H18  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[9]}]        -dict { PACKAGE_PIN J20  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[10]}]       -dict { PACKAGE_PIN G22  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[11]}]       -dict { PACKAGE_PIN K20  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[12]}]       -dict { PACKAGE_PIN J16  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[13]}]       -dict { PACKAGE_PIN J15  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[14]}]       -dict { PACKAGE_PIN K16  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM1_IO[15]}]       -dict { PACKAGE_PIN J14  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
...
set_property [get_ports {SRAM2_IO[0]}]        -dict { PACKAGE_PIN B17  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[1]}]        -dict { PACKAGE_PIN A19  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[2]}]        -dict { PACKAGE_PIN C17  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[3]}]        -dict { PACKAGE_PIN B20  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[4]}]        -dict { PACKAGE_PIN C19  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[5]}]        -dict { PACKAGE_PIN D20  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[6]}]        -dict { PACKAGE_PIN D16  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[7]}]        -dict { PACKAGE_PIN E16  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[8]}]        -dict { PACKAGE_PIN A17  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[9]}]        -dict { PACKAGE_PIN A20  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[10]}]       -dict { PACKAGE_PIN A18  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[11]}]       -dict { PACKAGE_PIN B19  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[12]}]       -dict { PACKAGE_PIN C18  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[13]}]       -dict { PACKAGE_PIN D18  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[14]}]       -dict { PACKAGE_PIN D19  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {SRAM2_IO[15]}]       -dict { PACKAGE_PIN E17  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
...
set_property [get_ports {CFG_MEM_IO[0]}]      -dict { PACKAGE_PIN R14  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {CFG_MEM_IO[1]}]      -dict { PACKAGE_PIN R15  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {CFG_MEM_IO[2]}]      -dict { PACKAGE_PIN P14  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {CFG_MEM_IO[3]}]      -dict { PACKAGE_PIN N14  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
...
set_property [get_ports {DATA_MEM1_IO[0]}]    -dict { PACKAGE_PIN K26  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {DATA_MEM1_IO[1]}]    -dict { PACKAGE_PIN L24  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {DATA_MEM1_IO[2]}]    -dict { PACKAGE_PIN L25  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {DATA_MEM1_IO[3]}]    -dict { PACKAGE_PIN K25  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
...
set_property [get_ports {DATA_MEM2_IO[0]}]    -dict { PACKAGE_PIN T25  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {DATA_MEM2_IO[1]}]    -dict { PACKAGE_PIN R26  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {DATA_MEM2_IO[2]}]    -dict { PACKAGE_PIN R25  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {DATA_MEM2_IO[3]}]    -dict { PACKAGE_PIN P26  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
...
set_property [get_ports {FRAM1_IO[0]}]        -dict { PACKAGE_PIN P21  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {FRAM1_IO[1]}]        -dict { PACKAGE_PIN P23  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {FRAM1_IO[2]}]        -dict { PACKAGE_PIN N21  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {FRAM1_IO[3]}]        -dict { PACKAGE_PIN P20  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
...
set_property [get_ports {FRAM2_IO[0]}]        -dict { PACKAGE_PIN M21  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {FRAM2_IO[1]}]        -dict { PACKAGE_PIN N22  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {FRAM2_IO[2]}]        -dict { PACKAGE_PIN N23  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
set_property [get_ports {FRAM2_IO[3]}]        -dict { PACKAGE_PIN R23  IOSTANDARD LVCMOS33 DRIVE 4 SLEW FAST PULLDOWN TRUE}
...
set_property [get_ports {UIO4_11_06[0]}]      -dict { PACKAGE_PIN Y15  IOSTANDARD LVCMOS33 PULLDOWN TRUE}
set_property [get_ports {UIO4_11_06[1]}]      -dict { PACKAGE_PIN AA15 IOSTANDARD LVCMOS33 PULLDOWN TRUE}

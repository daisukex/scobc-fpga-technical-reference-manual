...
reg [31:0] AHBAddr [0:SCVIP_AHBM_MAX_TRANS_CYCLE-1];
reg [SCVIP_AHBM_MAX_TRANS_CYCLE-1:0] AHBWrite;
reg [1:0] AHBBurst [0:SCVIP_AHBM_MAX_TRANS_CYCLE-1];
reg [2:0] AHBSize [0:SCVIP_AHBM_MAX_TRANS_CYCLE-1];
reg [4:0] AHBTlen [0:SCVIP_AHBM_MAX_TRANS_CYCLE-1];
reg [31:0] AHBData [0:SCVIP_AHBM_MAX_TRANS_CYCLE-1];
